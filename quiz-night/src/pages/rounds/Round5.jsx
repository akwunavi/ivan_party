...
export const ROUND5 = {
  ...
  correct_pairs: ['1А', '2В', '3Г', '4Б'],
    ...
    { content_type: 'choice', question_text: 'В какой из этих пар ответов приведено неверное утверждение?', 
      choices: [{ key: 'А', text: 'Монако - самая густонаселенная страна Европы по плотности населения' }, { key: 'Б', text: 'Ангара - одна из двух рек, вытекающие из Байкала' }, { key: 'В', text: 'Эверест - на территории Непала' }, { key: 'Г', text: 'Котловина Мертвого моря - самая низкая точка Азии' }],
