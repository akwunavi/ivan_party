...
export const ROUND1 = {
  ...
  rules: [
    ...
    'Ответы вносите на телефоне в течение раунда - кнопка "Отправить"',
...
answer_media_urls:['/media/ans_r1_6_1.jpg'],
 voice_audio: '/media/voices/1_6.mp3',
    ...
    {
      content_type: 'text',
      question_text: 'Этот цветок дал название сорту, который в США стал особенно популярен во второй половине XX века. Любопытно, что его название связано не с ботаническими особенностями, а с представлением об идеальной внешности. В одном известном фильме 1999 года этот образ становится практически навязчивым мотивом, хотя название фильма отсылает к тому же выражению уже в несколько ином смысле. Назовите фильм',
      answer_media_urls: ['media/ans_r1_7_1.jpg'],
    ...
    {
      content_type: 'video',
      question_text: 'Вы услышите отрывок из одной американской франшизы, известной более 50 лет, в немецком дубляже. Что за серия фильмов?',
    ...
    {
      content_type: 'image',
      question_text: 'Перед вами некий порядок фильмов. Поймите что это за порядок и назовите пропущенный фильм?',
...
answer_media_urls:['/media/ans_r1_9_1.jpg'],
 voice_audio: '/media/voices/1_9.mp3',
      correct_answer: 'Форрест Гамп',
        ...
        {
      content_type: 'text',
      question_text: 'Для съемок этого сериала 2006 года реквизиторы изготовили тысячи абсолютно одинаковых предметов размером всего несколько сантиметров. Каждый из них должен был выглядеть почти незаметным для окружающих, но бесценным для главного героя. Назовите сериал.',
      media_urls: [],
      choices: null,
