...
export const ROUND6 = {
  ...
  questions: [
    ...
    { content_type: 'text', question_text: 'Какому персонажу из комиксов принадлежат эти айтемы?', media_urls: ['/media/r6_5_1.jpg', '/media/r6_5_2.jpg'], answer_media_urls: ['/media/ans_r6_5_1.jpg'],voice_audio: '/media/voices/6_5.mp3', correct_answer: 'Харли Квин' },
    {
      content_type: 'text',
