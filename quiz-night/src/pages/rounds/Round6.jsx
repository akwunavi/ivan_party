...
export const ROUND6 = {
  ...
  questions: [
    { content_type: 'text', question_text: 'На этой картинке нейросеть сгенерировала живущего в настоящее время человека, которого называют немного странным прозвищем. Необходимо назвать реальное имя человека', media_urls: ['r6_6_1.jpg'], voice_audio: '/media/voices/6_1.mp3', correct_answer: 'Александр' },
    ...
    { content_type: 'text', question_text: 'Какому персонажу из комиксов принадлежат эти айтемы?', media_urls: ['/media/ans_r6_5_1.jpg', '/media/ans_r6_5_2.jpg'], answer_media_urls: ['/media/ans_r6_5_1.jpg'],voice_audio: '/media/voices/6_5.mp3', correct_answer: 'Харли Квин' },
    {
      content_type: 'text',
      question_text: 'ГЛАВНЫЙ ВОПРОС: какая тема объединяет все вопросы раунда?',
      media_urls: ['/media/ans_r6_6_1.jpg'],
